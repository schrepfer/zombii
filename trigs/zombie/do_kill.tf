...
;; $HeadURL: file:///storage/subversion/projects/ZombiiTF/zombii/trigs/zombie/do_kill.tf $
;;
/eval /loaded $[substr('$HeadURL: file:///storage/subversion/projects/ZombiiTF/zombii/trigs/zombie/do_kill.tf $', 10, -2)]
