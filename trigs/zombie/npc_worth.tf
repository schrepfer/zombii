...
;; $HeadURL: file:///storage/subversion/projects/ZombiiTF/zombii/trigs/zombie/npc_worth.tf $
;;
/eval /loaded $[substr('$HeadURL: file:///storage/subversion/projects/ZombiiTF/zombii/trigs/zombie/npc_worth.tf $', 10, -2)]
