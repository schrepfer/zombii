...
/def -Fp5 -mglob -t'You HEADCUT at * neck with a HARD swing!' stats_hitter_headcut = /add_stats_hitter headcut
/def -Fp5 -mglob -t'Your sword glows magically and echoes to your mind:*' stats_hitter_tameshivar = /add_stats_hitter tameshivar
...
/def -Fp5 -mglob -t'You strike with tremendous force, overwhelming * defenses!' stats_hitter_overwhelming_strike = /add_stats_hitter overwhelming
...
/def stats_hitter = \
  ...
  /execute %{_cmd} | $[pad('headcut', -25)] | $[pad(stats_hitter_headcut, 8)] ($[pad(round(stats_hitter_headcut * 100.0 / (stats_hitter_hit_calc ? stats_hitter_hit_calc : 1), 1), 5)]%%) | $[pad(stats_hitter_headcut_total, 8)] ($[pad(round(stats_hitter_headcut_total * 100.0 / (stats_hitter_hit_calc_total ? stats_hitter_hit_calc_total : 1), 1), 5)]%%) |%; \
  /execute %{_cmd} | $[pad('tameshivar', -25)] | $[pad(stats_hitter_tameshivar, 8)] ($[pad(round(stats_hitter_tameshivar * 100.0 / (stats_hitter_hit_calc ? stats_hitter_hit_calc : 1), 1), 5)]%%) | $[pad(stats_hitter_tameshivar_total, 8)] ($[pad(round(stats_hitter_tameshivar_total * 100.0 / (stats_hitter_hit_calc_total ? stats_hitter_hit_calc_total : 1), 1), 5)]%%) |%; \
  ...
  /execute %{_cmd} | $[pad('overwhelming strike', -25)] | $[pad(stats_hitter_overwhelming, 8)] ($[pad(round(stats_hitter_overwhelming * 100.0 / (stats_hitter_hit_calc ? stats_hitter_hit_calc : 1), 1), 5)]%%) | $[pad(stats_hitter_overwhelming_total, 8)] ($[pad(round(stats_hitter_overwhelming_total * 100.0 / (stats_hitter_hit_calc_total ? stats_hitter_hit_calc_total : 1), 1), 5)]%%) |%; \
  /execute %{_cmd} |---------------------------+-------------------+-------------------|%; \
