...
;; $HeadURL: file:///storage/subversion/projects/ZombiiTF/zombii/trigs/zombie/killed.tf $
;;
/eval /loaded $[substr('$HeadURL: file:///storage/subversion/projects/ZombiiTF/zombii/trigs/zombie/killed.tf $', 10, -2)]
