...
/def -Fp10 -msimple -t'This particular weapon is completely unknown to you.' wp_familiarity_1 = /substitute -p -- %{*} [@{B}1/16@{n}]
/def -Fp10 -msimple -t'You feel quite ill at ease, using this weapon.' wp_familiarity_2 = /substitute -p -- %{*} [@{B}2/16@{n}]
/def -Fp10 -msimple -t'You have spent brief moments, attempting to get to know this weapon.' wp_familiarity_3 = /substitute -p -- %{*} [@{B}3/16@{n}]
/def -Fp10 -msimple -t'You are still feeling rather awkward using this weapon.' wp_familiarity_4 = /substitute -p -- %{*} [@{B}4/16@{n}]
/def -Fp10 -msimple -t'You no longer feel quite so awkward with this weapon.' wp_familiarity_5 = /substitute -p -- %{*} [@{B}5/16@{n}]
/def -Fp10 -msimple -t'You have spent some time getting accustomed to this weapon.' wp_familiarity_6 = /substitute -p -- %{*} [@{B}6/16@{n}]
/def -Fp10 -msimple -t'You have spent quite some time getting accustomed to this weapon.' wp_familiarity_7 = /substitute -p -- %{*} [@{B}7/16@{n}]
/def -Fp10 -msimple -t'You are becoming rather accustomed to using this weapon.' wp_familiarity_8 = /substitute -p -- %{*} [@{B}8/16@{n}]
/def -Fp10 -msimple -t'You are very accustomed to using this weapon.' wp_familiarity_9 = /substitute -p -- %{*} [@{B}9/16@{n}]
/def -Fp10 -msimple -t'This weapon feels familiar to you.' wp_familiarity_10 = /substitute -p -- %{*} [@{B}10/16@{n}]
/def -Fp10 -msimple -t'This weapon is rather familiar to you.' wp_familiarity_11 = /substitute -p -- %{*} [@{B}11/16@{n}]
/def -Fp10 -msimple -t'This weapon is very familiar to you.' wp_familiarity_12 = /substitute -p -- %{*} [@{B}12/16@{n}]
/def -Fp10 -msimple -t'You feel at ease using this weapon.' wp_familiarity_13 = /substitute -p -- %{*} [@{B}13/16@{n}]
/def -Fp10 -msimple -t'You are starting to feel very natural, using this weapon.' wp_familiarity_14 = /substitute -p -- %{*} [@{B}14/16@{n}]
/def -Fp10 -msimple -t'You are starting to feel as if you were born with this weapon.' wp_familiarity_15 = /substitute -p -- %{*} [@{B}15/16@{n}]
/def -Fp10 -msimple -t'This weapon feels like a natural extension of your own arm.' wp_familiarity_16 = /substitute -p -- %{*} [@{B}16/16@{n}]
